...
import WriteBackSchemaNames from "@helpers/enums/WriteBackSchemaNames";
import { MutationContext } from "@hooks/actionOutput/useCreateActionInstance";
...
export const getMessageRequest = (state: ExecuteActionContextState) => {
    ...
    const request: ActionInstanceWithParameters = {
        model: actionInstance,
        ParameterInstances: apis
    }
