...
export class Fetcher {
	...
	*/
	...
	static async fetchData(httpsVerb: "GET", endpoint: "/actionDefinitionCardView", inputPayload: Entity.ActionDefinition): Promise<CustomInterface.ActionDefinitionCardViewResponse[]>; 
	...
	*/
	...
	static async fetchData(httpsVerb: "GET", endpoint: "/actionInstanceCardView", inputPayload: Entity.ActionInstance): Promise<CustomInterface.ActionInstanceCardViewResponse[]>; 
