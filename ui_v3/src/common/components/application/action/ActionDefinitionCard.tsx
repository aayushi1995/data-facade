...
import { APPLICATION_EDIT_ACTION_ROUTE_ROUTE } from '../../route_consts/data/ApplicationRoutesConfig';
import { StyledButtonActionCard, StyledTypographyApplicationDescription, StyledTypographyApplicationformCreatedOnString, StyledTypographyApplicationName } from '../compomentCssProperties';
