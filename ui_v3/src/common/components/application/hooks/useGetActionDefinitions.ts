...
export const useGetActionDefinitions = (): [ActionDefinitionCardViewResponse[], any, boolean] => {
    ...
    const {data: applications, error: applicationError, isLoading: applicationsLoading} = useQuery(["ActionDefinition", "CardView"], () => Fetcher.fetchData("GET", "/actionDefinitionCardView", { IsVisibleOnUI: true }))
