...
import { ModuleContextState } from "../main_module/context/ModuleContext";
import { ModuleContent } from "../main_module/ModuleContent";
import ModuleSwitcherIcon from './assets/images/module-switcher.svg';
